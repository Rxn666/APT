...
_C.DATA.ROOT_DIR = '../data/UCF101/UCF101'
_C.DATA.OUTPUT_DIR = 'UCF101_frames'
...
_C.PROMPT = CfgNode()
_C.PROMPT.ATTRIBUTE = True
_C.PROMPT.ATTRIBUTE_DIR = '/home/yqx/yqx_softlink/data/UCF101/224_features'
_C.PROMPT.ATTRIBUTE_MODE = ''
_C.PROMPT.ATTRIBUTE_DEPTH_NUM = []

_C.TRICKS = CfgNode()
_C.TRICKS.ADAPTER = True
_C.TRICKS.FLIP = True
_C.TRICKS.CROP = True
