...
def I3D_model(num_classes, check_point):
    model = I3D(num_classes, modality='rgb')
    check_point = torch.load(check_point)
    check_point.pop('conv3d_0c_1x1.conv3d.weight')
    check_point.pop('conv3d_0c_1x1.conv3d.bias')
    msg = model.load_state_dict(check_point, strict=False)
    print(msg)
